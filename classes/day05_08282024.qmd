...
- **A few things to review**  
  ...
  When we compute $\hat{\beta}$, there are no systematic mechanisms in the computation of $\hat{\beta}$ that will lead to over/underestimation of $\beta$. That is why we expect to obtain $\beta$ (i.e., the "true" $\beta$) back.   
