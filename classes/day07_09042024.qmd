...
We are looking at  
$$\hat{\beta_0}+\hat{\beta_1}x \pm t_{dfe, 1-\alpha/2}s.e. (\hat{\beta_0}+\hat{\beta_1}x),$$
where $s.e.(\hat{\beta_0}+\hat{\beta_1}x) = \hat{\sigma}\sqrt{\frac{1}{n}+ \frac{(x-\hat\mu_x)^2}{(n-1)s_x^2}}$.  
