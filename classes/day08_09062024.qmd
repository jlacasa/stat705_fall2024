...
[Remember the simulation?](https://jlacasa.github.io/stat705_fall2024/classes/in_class_code/day8_simulation_ _example) [[R code](https://github.com/jlacasa/stat705_fall2024/tree/main/classes/in_class_code/day8_simulation_ _example.qmd)]
...
```{r}
opd_se_hat <- msm::deltamethod(g = ~ -x2/x3, mean = coef(m), cov = covariance)
