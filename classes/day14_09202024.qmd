...
where $y_{ij}$ is the observation of crown biomass for the $i$th observation of the $j$th treatment, $\mu{ij}$is its mean and $\sigma^2$ its variance. The means is described with $\beta_{0j}$, the intercept of the $j$th treatment and $\beta_{1j}$, the slope of the $j$th treatment.  
