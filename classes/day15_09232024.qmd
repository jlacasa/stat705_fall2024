...
Other types of objectives (that require other types of modeling tools) would be "to predict y for given levels of A and B" (e.g., predict corn yield with 150 kg N per ha and 20 inches rainfall in the season), or "".
