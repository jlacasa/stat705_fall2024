...
```{r}
m1 <- lm(G3 ~ prev_grade : school, data = dd)
m2 <- lm(G3 ~ prev_grade : school + student_ID , data = dd)
coef(m2)[1:10]
m3 <- lm(G3 ~ prev_grade : school : student_ID , data = dd)
m4 <- lme(G3 ~ prev_grade : school, random = ~ 1|student_ID, data = dd)
m4
m5 <- lme(G3 ~ prev_grade : school, random = ~ 0+prev_grade|student_ID, data = dd)
m5
```
